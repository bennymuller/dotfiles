...
sudo scutil --set ComputerName "Bennys-MacBook-Pro"
sudo scutil --set HostName "Bennys-MacBook-Pro"
sudo scutil --set LocalHostName "Bennys-MacBook-Pro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Bennys-MacBook-Pro"
