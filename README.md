...
These are my dotfiles. WIP

For OS X, but may work on Linux, Take anything you want, but at your own risk.
...
### Clone with Git
    ...
    git clone https://github.com/bennymuller/dotfiles.git
...
Alternatively, you can install this into `~/.dotfiles` remotely without Git using curl:
    ...
    sh -c "`curl -fsSL https://raw.github.com/bennymuller/dotfiles/master/remote-install.sh`" 

Or, using wget:

    sh -c "`wget -O - --no-check-certificate https://raw.githubusercontent.com/bennymuller/dotfiles/master/remote-install.sh`"
